...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>petugas/Temuan/create"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Penemuan"><i class="fa fa-plus"></i>  Tambah Penemuan</a></div>
   <table id="table-buku" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>No</th>
        ...
        ?>
            <tr>
               <td><?php echo $no++ ;?></td>
                ...
                <td>
                <?php echo 
                    '<a href="'.base_url().'petugas/Temuan/edit_temuan/?id_penemuan='.$op['id_penemuan'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'petugas/Temuan/hapus_temuan/?id_penemuan='.$op['id_penemuan'].'">
