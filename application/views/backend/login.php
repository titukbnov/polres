				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<i class="ace-icon fa fa-building-o black"></i>
									<span class="black">Sistem Informasi</span>
									<span class="white" id="id-text2">Pengaduan Kendaraan Hilang</span>
								</h1>
								<h4 class="black" id="id-company-text">&copy; POLRES ABEPURA</h4>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												<center><i class="ace-icon fa fa-user black"></i>
													<p>Silakan Masukan <p>Username dan Password</p></p>
												</center>
										...
										<div class="toolbar clearfix">
											<div>
												<a href="<?php echo base_url(); ?>home/"  class="user-signup-link">
													Back to Home
